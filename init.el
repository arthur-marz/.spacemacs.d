...
values."
  (setq-default
   ...
   '(
     ...
     scheme
     (haskell :variables
              haskel-process-type 'stack-ghci)
     javascript
     haskell
     emacs-lisp
     html
   ...
   dotspacemacs-additional-packages '(helm-dictionary
                                      nov
                                      evil-collection)
...
you should place your code here."
  ...
  ;; Vim-like keybinding for opening according file in split rather then switching in place
  (evil-ex-define-cmd
   "AV"
   (lambda () (interactive)
     (evil-window-vsplit)
